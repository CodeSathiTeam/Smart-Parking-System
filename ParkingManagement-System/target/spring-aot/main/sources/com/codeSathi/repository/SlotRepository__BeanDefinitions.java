...
/**
 * Bean definitions for {@link SlotRepository}.
 */
@Generated
public class SlotRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'slotRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getSlotRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'slotRepository'.
   */
  public static BeanDefinition getSlotRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, SlotRepository.class, Slot.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.codeSathi.repository.SlotRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.SlotRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.codeSathi.repository.SlotRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getSlotRepositoryInstanceSupplier();
